<html>
	<head>
		...
		<link rel="stylesheet" href="samples/css/bootstrap.min.css" />
		<script type="text/javascript" src="samples/js/jquery-1.8.2.min.js"></script>
		<script type="text/javascript" src="samples/js/bootstrap.js"></script>
	</head>
	<body>
		<div class="container">
			<div class="row">
				<div class="span12">
					<h1>CFDYNAMO</h1>
					<h2>You're running the CFDynamo Amazon AWS DynamoDB connector sample application.</h2>
					<p>
