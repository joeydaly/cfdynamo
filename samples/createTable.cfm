<cfscript>
	...
	// If someone has posted to the page, it's probably a form submission
	// so grab that data and start creating some table!
	...
	// We will want a list of the tables currently up there now
	my_tables = cfdynamo.list_tables(limit=20);
