...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="registerProtocol" access="public" returntype="void" hint="I register a protocol with the settings.">
		<cfargument name="class" 		required="false" default="mockbox.system.core.mail.protocols.CFMailProtocol" hint="The instantiation path of the mail protocol object"/>
