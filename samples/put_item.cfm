<cfscript>
	// Setup the credentials and initialize the connector.
	...
	// Here's where we look to see if data was posted to the page for "put"-ing into the DDB.
	...
	// Try to get a table listing from the remote service.
	try{
